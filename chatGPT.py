...
# To-do: Allow continuation of conversations by setting conversation_ID
...
# Set a conversation ID to allow continuation of conversations
#conversation_id="xxx"
...
# Exit if the user fails to enter a prompt
if prompt=="":
        sys.exit("\t  - Prompt should not be blank")
